...
export default function Home() {
  ...
  <div className='font-[wg] text-center'>
    ...
    <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }}   className=' absolute bottom-16 right-[40%] z-10'>
    ...
    <main className='flex flex-col items-center justify-between relative '>
      ...
      <div className=' absolute top-0 left-8 w-[80%] text-white'>
        <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }}  className='text-left relative'>
          <p className={`${wg.className} text-4xl mt-6 m-0 absolute top-0 font-extrabold`}>Толеген</p>
          <p className={`${wg.className} absolute top-16 text-3xl`}>70 жас мерей тойы <br />10.05.2025</p>
        </motion.div>
      </div>
      <CountDown />
    ...
    <div className='flex flex-col font-bold  w-[80%] mx-auto mt-4 justify-between text-black h-[110%]'>
        <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }} className=' text-center  p-3 rounded-lg text-2xl'>
          ...
          <i> <p className=' text-lg'>Ағайын-туыс, құда-жекжат, нағашы-жиен, бөлелер, дос-жаран, көршілер! 
                                      Сіздерді, Асқар таудай әкеміз Шалабеков Төлеген Аманкенұлы 70 жас мерей тойына арналған салтанатты кешіміздің қадірлі қонағы болуға шақырамыз!
          </p></i>
        </motion.div>
    </div>
{/* 
    <div className='relative flex justify-center mb-[340px] bg-mramor'>
        ...
        <motion.img initial={{ rotate: 0, x: 100, opacity: 0 }} whileInView={{ opacity: 1, rotate: -25, x: 0  }} transition={{ duration: 1 }} src='/2.JPG' alt='Section' className='w-auto mx-auto mt-10 rounded-lg absolute -rotate-[25deg] top-10 left-6 h-[200px]'/>
        <motion.img src='/1.png' alt='Section' className=' object-cover w-[40%] mx-auto mt-10  rounded-lg absolute h-[250px] bg-[rgba(0,0,0,0.5)]'/>
    </div> */}


    <div className='relative flex justify-center mb-[340px] bg-mramor'>
        <motion.img initial={{ rotate: 0, x: -100, opacity: 0 }} whileInView={{ opacity: 1, rotate: 20, x: 0 }} transition={{ duration: 1 }} src='/3.jpeg' alt='Section' className='object-cover w-[40%] mx-auto mt-10   rounded-lg absolute rotate-[20deg] top-10 right-5 h-[200px]'/>
        <motion.img initial={{ rotate: 0, x: 100, opacity: 0 }} whileInView={{ opacity: 1, rotate: -25, x: 0  }} transition={{ duration: 1 }} src='/3.jpeg' alt='Section' className='object-cover w-[40%] mx-auto mt-10 rounded-lg absolute -rotate-[25deg] top-10 left-6 h-[200px]'/>
    ...
    <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }} className='w-[80%] font-bold mx-auto text-center relative mb-[200px] border-[#96825f] border-[1px] '>
        <i><p className={`text-2xl mt-6 m-0 absolute top-0 right-10`}>10.05.2025 | 13:00 | сенбі</p></i>
    </motion.div>
    ...
    <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }}   className=' flex flex-col w-[80%] mx-auto p-4 rounded-lg relative overflow-hidden right-0 justify-center items-center text-lg '>
      ...
      <p className=' text-lg font-extrabold'>Aisara Hall банкет залы</p>
      <p className=' text-lg font-extrabold'>Қайым Мұхамедханұлы 52/1 <br />
Нұра ауданы, Астана</p>
    ...
    <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }}   className=' flex flex-col w-[80%] mx-auto mb-[100px] ] p-4 rounded-lg relative overflow-hidden right-0 justify-center items-center text-lg '>
      <img src="/wh.png" alt="2gis" className=' h-[100px] w-[100px] mt-12' onClick={(e) => {
