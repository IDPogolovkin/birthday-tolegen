...
export default function Home() {
  ...
  <div className='font-[wg] text-center'>
    <main className='flex flex-col items-center justify-between relative '>
      ...
      <div className=' absolute top-0 left-8 w-[80%] text-white'>
        ...
        <div className=' font-bold  w-[88%] max-w-[370px] justify-between text-black h-[100%] mt-2'>
          ...
          <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }}   className=' absolute bottom-36 right-[13%] z-15 mt-2'>
          ...
          <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }} className='mb-4 text-center  p-3 rounded-lg text-2xl '>
              ...
              <i> <p className=' text-lg '>Ағайын-туыс, құда-жекжат, нағашы-жиен, бөлелер, дос-жаран, көршілер! 
                                          Сіздерді, Асқар таудай әкеміз Төлеген Аманкенұлы 70 жас мерей тойына арналған салтанатты кешіміздің қадірлі қонағы болуға шақырамыз!
              </p></i>
            </motion.div>
      </div>
    </main>
    ...
    <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }}   className=' flex flex-col w-[80%] mx-auto mb-[20px] ] p-4 rounded-lg relative overflow-hidden right-0 justify-center items-center text-lg '>
      <img src="/wh.png" alt="2gis" className=' h-[75px] w-[75px] mt-12 cursor-pointer' onClick={(e) => {
    ...
    <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }} className='pb-1'>
